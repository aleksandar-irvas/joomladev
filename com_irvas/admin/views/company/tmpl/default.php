...
irvas&view=irvas'); ?>" method="post" name="adminForm" id="adminForm">
                        ...
                        <tr class="row<?php echo $i % 2; ?>">
                            <td class="center hidden-phone">
                                <?php echo JHtml::_('grid.id', $i, $item->id); ?>
                                    [ 167 ]Getting Started with Component Development
                            </td>
                            <td class="nowrap has-context">
                                <a href="<?php echo
JRoute::_('index.php?option=com_irvas&task=
irvas.edit&id='.(int) $item->id); ?>">
